...
module Gem::Requirement::CorrectHashForLambdaOperator
  # source://bundler/2.3.8/lib/bundler/rubygems_ext.rb#179
  def hash; end
end

module Gem::Requirement::OrderIndependentComparison
  # source://bundler/2.3.8/lib/bundler/rubygems_ext.rb#149
  def ==(other); end

  protected

  # source://bundler/2.3.8/lib/bundler/rubygems_ext.rb#161
  def _requirements_sorted?; end

  # source://bundler/2.3.8/lib/bundler/rubygems_ext.rb#167
...
module Gem::Specification::YamlBackfiller
  # source://bundler/2.3.8/lib/bundler/rubygems_ext.rb#84
