...
class Packwerk::ApplicationValidator
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#119
  sig { params(configuration: ::Packwerk::Configuration).returns(::Packwerk::ApplicationValidator::Result) }
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#176
  sig { params(configuration: ::Packwerk::Configuration).returns(::Packwerk::ApplicationValidator::Result) }
  def check_root_package_exists(configuration); end

  # source://packwerk//lib/packwerk/application_validator.rb#140
  sig { params(configuration: ::Packwerk::Configuration).returns(::Packwerk::ApplicationValidator::Result) }
  ...
  #   ["a -> b -> c -> a", "b -> c -> b"]
  #
  # source://packwerk//lib/packwerk/application_validator.rb#202
  sig { params(cycles: T.untyped).returns(T::Array[::String]) }
  def build_cycle_strings(cycles); end

  # source://packwerk//lib/packwerk/application_validator.rb#211
  sig { params(list: T.untyped).returns(T.untyped) }
  def format_yaml_strings(list); end

  # source://packwerk//lib/packwerk/application_validator.rb#221
  ...
  # source://packwerk//lib/packwerk/application_validator.rb#216
...
class Packwerk::Configuration
  ...
  class << self
    # @raise [ArgumentError]
    #
    # source://packwerk//lib/packwerk/configuration.rb#10
    def from_path(path = T.unsafe(nil)); end

    private

    # source://packwerk//lib/packwerk/configuration.rb#24
    def from_packwerk_config(path); end
  end
end

# source://packwerk//lib/packwerk/configuration.rb#32
...
# source://packwerk//lib/packwerk/configuration.rb#33
...
class Packwerk::Formatters::OffensesFormatter
  ...
  # source://packwerk//lib/packwerk/formatters/offenses_formatter.rb#12
  sig { params(style: ::Packwerk::OutputStyle).void }
  def initialize(style: T.unsafe(nil)); end

  # source://packwerk//lib/packwerk/formatters/offenses_formatter.rb#17
  sig { override.params(offenses: T::Array[T.nilable(::Packwerk::Offense)]).returns(::String) }
  def show_offenses(offenses); end

  # source://packwerk//lib/packwerk/formatters/offenses_formatter.rb#27
  sig do
    override
      .params(
  ...
  # source://packwerk//lib/packwerk/formatters/offenses_formatter.rb#46
  sig { params(offenses: T::Array[T.nilable(::Packwerk::Offense)]).returns(::String) }
...
class Packwerk::Graph
  ...
  # source://packwerk//lib/packwerk/graph.rb#68
  def add_cycle(cycle); end

  # source://packwerk//lib/packwerk/graph.rb#61
  def neighbours(node); end

  # source://packwerk//lib/packwerk/graph.rb#24
  def nodes; end

  # source://packwerk//lib/packwerk/graph.rb#28
  def process; end

  # source://packwerk//lib/packwerk/graph.rb#36
...
module Packwerk::OffensesFormatter
  ...
  # @abstract
  #
  # source://packwerk//lib/packwerk/offenses_formatter.rb#12
  sig { abstract.params(offenses: T::Array[T.nilable(::Packwerk::Offense)]).returns(::String) }
  def show_offenses(offenses); end

  # @abstract
  #
  # source://packwerk//lib/packwerk/offenses_formatter.rb#16
  sig do
    abstract
      .params(
        offense_collection: ::Packwerk::OffenseCollection,
...
class Packwerk::ParseRun
  ...
  # source://packwerk//lib/packwerk/parse_run.rb#36
  sig { returns(::Packwerk::Result) }
