...
module Mocha::API
  ...
  #
  # source://mocha//lib/mocha/api.rb#70
  ...
  #
  # source://mocha//lib/mocha/api.rb#219
  ...
  # @see StateMachine
  #
  # source://mocha//lib/mocha/api.rb#248
  def states(name); end
  ...
  # @return [Mock] a new mock object
  #
  # source://mocha//lib/mocha/api.rb#116
  ...
  # @return [Mock] a new mock object
  #
  # source://mocha//lib/mocha/api.rb#164
...
class Mocha::Configuration
  ...
  # @param value [Boolean] +true+ to reinstate undocumented behaviour; disabled by default.
  #
  # source://mocha//lib/mocha/configuration.rb#298
  def reinstate_undocumented_behaviour_from_v1_9=(value); end

  # @private
  # @return [Boolean]
  #
  # source://mocha//lib/mocha/configuration.rb#313
  ...
  class << self
    ...
    #
    # source://mocha//lib/mocha/configuration.rb#328
    def allow(action, &block); end

    # @private
    # @return [Boolean]
    #
    # source://mocha//lib/mocha/configuration.rb#338
    def allow?(action); end

    # @private
    #
    # source://mocha//lib/mocha/configuration.rb#416
    def configuration; end
    ...
    #
    # source://mocha//lib/mocha/configuration.rb#407
    ...
    # @yield optional block during which the configuration change will be changed before being returned to its original value at the end of the block.
    #
    # source://mocha//lib/mocha/configuration.rb#376
    def prevent(action, &block); end

    # @private
    # @return [Boolean]
    #
    # source://mocha//lib/mocha/configuration.rb#386
    def prevent?(action); end

    # @private
    #
    # source://mocha//lib/mocha/configuration.rb#391
    ...
    # @yield optional block during which the configuration change will be changed before being returned to its original value at the end of the block.
    #
    # source://mocha//lib/mocha/configuration.rb#352
    def warn_when(action, &block); end

    # @private
    # @return [Boolean]
    #
    # source://mocha//lib/mocha/configuration.rb#362
    ...
    # @private
    #
    # source://mocha//lib/mocha/configuration.rb#423
    def change_config(action, new_value, &block); end

    # @private
    #
    # source://mocha//lib/mocha/configuration.rb#432
...
class Mocha::Invocation
  ...
  # source://mocha//lib/mocha/invocation.rb#79
...
#   object.expected_method # => raises exception of class Exception1
#
# source://mocha//lib/mocha/mock.rb#74
class Mocha::Mock
  # @private
  # @return [Mock] a new instance of Mock
  #
  # source://mocha//lib/mocha/mock.rb#272
  ...
  #
  # source://mocha//lib/mocha/mock.rb#109
  def __expects__(method_name_or_hash, backtrace = T.unsafe(nil)); end

  # @private
  #
  # source://mocha//lib/mocha/mock.rb#342
  def __expire__; end
  ...
  # @private
  #
  # source://mocha//lib/mocha/mock.rb#316
  def handle_method_call(symbol, arguments, block); end

  # @private
  #
  # source://mocha//lib/mocha/mock.rb#352
  def inspect; end

  # @private
  #
  # source://mocha//lib/mocha/mock.rb#311
  def method_missing(symbol, *arguments, &block); end

  # @private
  #
  # source://mocha//lib/mocha/mock.rb#347
  def mocha_inspect; end
  ...
  #
  # source://mocha//lib/mocha/mock.rb#234
  ...
  # @see #responds_like
  #
  # source://mocha//lib/mocha/mock.rb#267
  ...
  #
  # source://mocha//lib/mocha/mock.rb#179
  def unstub(*method_names); end

  private

  # source://mocha//lib/mocha/mock.rb#385
  ...
  # @return [Boolean]
  #
  # source://mocha//lib/mocha/mock.rb#328
...
# source://mocha//lib/mocha/stubbed_method.rb#4
class Mocha::StubbedMethod
  # @return [StubbedMethod] a new instance of StubbedMethod
  #
  # source://mocha//lib/mocha/stubbed_method.rb#9
  def initialize(stubbee, method_name); end

  def ==(_arg0); end

  # source://mocha//lib/mocha/stubbed_method.rb#56
  ...
  # @return [Boolean]
  #
  # source://mocha//lib/mocha/stubbed_method.rb#81
  ...
  # source://mocha//lib/mocha/stubbed_method.rb#88
  def to_s; end

  # source://mocha//lib/mocha/stubbed_method.rb#21
  def unstub; end

  private

  # source://mocha//lib/mocha/stubbed_method.rb#107
  def remove_original_method_from_stubbee; end

  # source://mocha//lib/mocha/stubbed_method.rb#94
  def retain_original_visibility(method_owner); end

  # source://mocha//lib/mocha/stubbed_method.rb#99
  def store_original_method_visibility; end

  # @return [Boolean]
  #
  # source://mocha//lib/mocha/stubbed_method.rb#103
  def stub_method_overwrites_original_method?; end

  # source://mocha//lib/mocha/stubbed_method.rb#120
  def stub_method_owner; end

  # source://mocha//lib/mocha/stubbed_method.rb#115
  def use_prepended_module_for_stub_method; end

  # @return [Boolean]
  #
  # source://mocha//lib/mocha/stubbed_method.rb#111
  def use_prepended_module_for_stub_method?; end
end
