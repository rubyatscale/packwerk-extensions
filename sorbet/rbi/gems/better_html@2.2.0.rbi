...
class BetterHtml::Parser::Error < ::BetterHtml::HtmlError
  ...
  #
  # source://better_html//lib/better_html/parser.rb#18
  def loc; end
...
class BetterHtml::Tokenizer::Location < ::Parser::Source::Range
  ...
  # source://better_html//lib/better_html/tokenizer/location.rb#36
  def start_column; end

  # source://better_html//lib/better_html/tokenizer/location.rb#34
  def start_line; end

  # source://better_html//lib/better_html/tokenizer/location.rb#37
  def stop_column; end

  # source://better_html//lib/better_html/tokenizer/location.rb#35
  def stop_line; end
